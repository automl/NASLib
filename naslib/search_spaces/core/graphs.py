...
class EdgeOpGraph(nx.DiGraph, MetaEdgeOpGraph):
    ...
    def forward(self, inputs):
        ...
        assert len(self.input_nodes) == len(inputs), "Number of inputs isn't the same as the number of inputs in the graph"
        for input_node, input in zip(self.input_nodes, inputs):
