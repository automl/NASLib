...
LCEPredictor, OmniPredictor, OmniXGBPredictor, GPWLPredictor
...
supported_predictors = {
    ...
    'gpwl2': GPWLPredictor(ss_type=config.search_space, kernel_type='wloa', optimize_gp_hyper=True, h=2),
    ...
    'omni_seminas': OmniSemiNASPredictor(encoding_type='seminas', semi=True, hpo_wrapper=False,
                                         ...
                                         lce=['sotle']),
    'omni_seminas_lofi': OmniSemiNASPredictor(encoding_type='seminas', semi=True, hpo_wrapper=False,
                                              jacov_onehot=True, config=config, zero_cost=['jacov'], 
                                              lce=[]),
