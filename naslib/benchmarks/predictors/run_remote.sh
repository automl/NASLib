...
do
    ...
    python NASLib/naslib/utils/create_configs.py --predictor $predictor --experiment_type $experiment_type \
...
do
 ...
 do
     ...
     python NASLib/naslib/benchmarks/predictors/runner.py --config-file $config_file
 done
done
