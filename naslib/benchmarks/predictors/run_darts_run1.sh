predictors=(lcsvr sotle bonas \
ngb rf xgb gbdt omni_both)
experiment_types=(vary_both vary_fidelity vary_train_size \
vary_train_size vary_train_size vary_train_size vary_train_size vary_both)
