...
python runner.py --config-file bo201_may19_0/cifar10/configs/nas_predictors/config_bananas_${1}_${SLURM_ARRAY_TASK_ID}.yaml
#python runner.py --config-file np201_may19_0/cifar10/configs/nas_predictors/config_npenas_${1}_${SLURM_ARRAY_TASK_ID}.yaml
