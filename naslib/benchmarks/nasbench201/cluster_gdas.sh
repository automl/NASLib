#!/bin/bash
#SBATCH -p gpu_tesla-P100     #gpu_tesla-P100     #ml_gpu-rtx2080     # bosch_gpu-rtx2080    #alldlc_gpu-rtx2080     # partition (queue)
...
#SBATCH -J nb201-gdas         # sets the job name. 
...
python runner.py --config-file config.yaml --seed 1 --optimizer gdas --eval-only
