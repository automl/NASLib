...
#SBATCH --mem 10000           # memory pool for all cores (4GB)
...
#SBATCH -J nb2-re             # search space - algorithm
...
python runner.py --config-file config_cifar10.yaml --seed 4 --optimizer re search.checkpoint_freq 100 search.epochs 2000
