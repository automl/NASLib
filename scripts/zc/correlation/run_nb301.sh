...
do
    ...
    do
        ...
        # sbatch ./zc/scripts/correlation/run.sh $searchspace $dataset $pred $start_seed $experiment --bosch
        bash ./scripts/zc/correlation/run.sh $searchspace $dataset $pred $start_seed $experiment --bosch
