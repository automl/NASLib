...
def main(args):
    if args.config_type == 'predictor':
        folder = f'{args.config_root}/{args.dataset}/'
        print(folder)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--start_seed", type=int, default=9001, help="starting seed")
    ...
    parser.add_argument("--config_type", type=str, default='predictor', help="nas or predictor?")
